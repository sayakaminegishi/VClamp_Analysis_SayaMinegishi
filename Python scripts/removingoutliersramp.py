...
#function to identify and remove outliers based on Z-score
def remove_outliers(data, threshold=3):
    """
    Remove outliers from a dataset using the Z-score method.
    
    Parameters:
    - data: The dataset from which to remove outliers (numpy array).
...
# Remove outliers from the voltage and current data
avg_voltages = remove_outliers(avg_voltages)
avg_currents = remove_outliers(avg_currents)
